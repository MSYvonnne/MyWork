...
public class List1Activity extends ListActivity implements Runnable,AdapterView.OnItemClickListener,AdapterView.OnItemLongClickListener {
        ...
        handler = new Handler(){
            ...
            public void handleMessage(Message msg){
                if(msg.what==7){
                    ...
                    listItemAdapter = new SimpleAdapter(List1Activity.this,listItems,//listitem数据源
                            R.layout.activity_list1, //listitem的XML布局实现
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        //打开新的页面，传参
        Intent rateCalc = new Intent(this,Main2Activity.class);
